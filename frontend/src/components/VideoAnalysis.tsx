...
const mockVideoFeeds: VideoFeed[] = mockStudents.slice(0, 6).map((s) => ({
    studentName: s.name,
    emotion: s.emotion,
...
export default function VideoAnalysis() {
    ...
    const feed = mockVideoFeeds[selectedFeed];
                ...
                <div className="flex">
                    ...
                    <div className="flex-1 bg-[#1A1A2E] relative" style={{ minHeight: 400 }}>
                        <div className="absolute inset-0 flex flex-col items-center justify-center">
                            ...
                            <p className="text-[#AFAFAF] text-xs font-bold mt-1">Video feed preview</p>
                        </div>

                        {/* Live badge */}
                        {feed.isLive && (
                            <div className="absolute top-4 left-4 flex items-center gap-1.5 bg-[#FF4B4B] px-3 py-1.5 rounded-full">
                        ...
                        {/* Duration */}
                        <div className="absolute top-4 right-4 bg-[#0D0D1A] bg-opacity-80 px-3 py-1.5 rounded-full">
                        ...
                        <div className="absolute bottom-4 left-4 right-4">
                            <div className="bg-[#0D0D1A] bg-opacity-90 rounded-2xl p-4 flex items-center justify-between">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p className="text-white font-extrabold text-sm">Detected Emotion</p>
