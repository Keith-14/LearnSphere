                    ...
                    <>
                        <div className="mb-8 flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-[#AFAFAF] font-bold mt-0.5">Understand your emotional patterns across study sessions</p>
                            </div>
                        </div>
                                ...
                                {mockRecentSessions.map((s) => (
                                    <div key={s.id} className="flex items-center justify-between p-4 rounded-xl bg-[#F7F7F7] border-2 border-[#E5E5E5]">
                                        <div className="flex items-center gap-3">
                                            <Image src={pingoAvatars[s.emotion]} alt={s.emotion} width={32} height={32} className="rounded-full" />
                                            <div>
